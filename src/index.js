...
function staffPanel(){const b=['# 👨‍💻 Кто есть кто','','⚠️ **Никто из администрации не пишет первым в личные сообщения** и никогда не запрашивает данные от аккаунта.','Если вам написали от имени персонала — сверьтесь со списком ниже и сообщите в поддержку.','','▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬','','### 👑 Управление','<@&1424466632511852654>','Владелец проекта: развитие и стратегия','','<@&1548588658733482004>','Оперативное управление проектом','','<@&1424467306469261433>','Набор, обучение и дисциплина персонала','','### ⚔️ Администрация','<@&1424466768977596567>','Спорные ситуации и апелляции','','<@&1424467624821260379>','Проверки, блокировки и работа с нарушителями','','<@&1548589804370010163>','Администратор на испытательном сроке','','### 🔨 Модерация','<@&1548590124189749338>','Чат, жалобы, блокировки чата и предупреждения','','<@&1548589973178028084>','Модератор на испытательном сроке','','### 🎬 Медиа','<@&1482122982645170268>','Создание контента о проекте','','@everyone'].join('\n');return new ContainerBuilder().setAccentColor(0xa8e063).addTextDisplayComponents(new TextDisplayBuilder().setContent(b));}
